...
def collate_fn(batch):
    ...
    arg_labels = [f["arg_labels"] for f in batch]
    ...
    arg_labels = [torch.tensor(label) for label in arg_labels]
    arg_labels = torch.cat(arg_labels, dim=0)
    ...
    output = (input_ids, input_mask, labels, entity_pos, hts, sent_pos, sent_labels_tensor, attns, arg_labels)
